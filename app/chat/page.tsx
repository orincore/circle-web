...
export default function ChatPage() {
  ...
  // Send message with optimistic update and socket emit
  ...
  // Block/Unblock partner using appropriate endpoint
  ...
  // Toggle Archive/Unarchive: if archived, call unarchive endpoint; otherwise, archive.
            ...
            <div className="overflow-y-auto h-[calc(100%-4rem)]">
              {chats.map(chat => (
                <motion.div
                  ...
                  className={`p-4 flex items-center space-x-3 cursor-pointer ${activeChat?._id === chat._id ? "bg-muted" : ""}`}
